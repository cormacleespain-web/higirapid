...
export default function FloatingCta() {
  ...
  return (
    <motion.a
      ...
      className="floating-cta-pulse fixed bottom-6 right-6 z-50 flex md:hidden items-center justify-center w-14 h-14 bg-emerald-600 text-white rounded-full shadow-lg hover:bg-emerald-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 transition-colors duration-150"
